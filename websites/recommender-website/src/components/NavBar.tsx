    ...
    return (
        <div className="flex justify-between items-center px-4 py-2 bg-gray-800 text-white">
            <div className="flex-grow">
                <button className="text-sm navbar-btn md:text-lg mr-2 sm:mr-4" onClick={() => setCurrentView(NavbarView.HomePage)}>
                    Home Page
                </button>
                <button className="text-sm md:text-lg mr-2 sm:mr-4" onClick={() => setCurrentView(NavbarView.FindNewGames)}>
                    Find New Games
                </button>
                <button className="text-sm md:text-lg mr-2 sm:mr-4" onClick={() => setCurrentView(NavbarView.Interactions)}>
                    Interactions
                </button>
