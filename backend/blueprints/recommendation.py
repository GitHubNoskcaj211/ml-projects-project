...
model_wrappers = [
    ...
    ModelWrapper(
        NCFModel,
        "evaluation_test_cf_low_weight_decay_increased_lr",
        "test_evaluation_data_loader",
        None,
    ),
    ModelWrapper(
        NCFModel,
        "evaluation_test_gcf_low_weight_decay_increased_lr",
        "test_evaluation_data_loader",
        None,
    ),
    ModelWrapper(
        NCFModel,
        "evaluation_test_mlp_low_weight_decay_increased_lr",
        "test_evaluation_data_loader",
        None,
    ),
    ModelWrapper(
        NCFModel,
        "evaluation_test_ncf_low_weight_decay_increased_lr",
        "test_evaluation_data_loader",
        None,
    ),
    ModelWrapper(
        NCFModel,
        "evaluation_test_cf_embed_all_except_tags_genres",
        "test_evaluation_data_loader_embed_all_except_tags_genres",
        None,
    ),
    ModelWrapper(
        NCFModel,
        "evaluation_test_gcf_embed_all_except_tags_genres",
        "test_evaluation_data_loader_embed_all_except_tags_genres",
        None,
    ),
    ModelWrapper(
        NCFModel,
        "evaluation_test_mlp_embed_all_except_tags_genres",
        "test_evaluation_data_loader_embed_all_except_tags_genres",
        None,
    ),
    ModelWrapper(
